        ...
        >
            ...
            >
              <View style={styles.premiumContent}>
                ...
                <ThemedText style={styles.premiumTitle}>
                  Get full access to Lingos
                </ThemedText>
                <ThemedText style={styles.premiumSubtitle}>
                  Unlock Lingos Premium to get access to custom scenarios and more
                </ThemedText>
                <View style={styles.premiumButton}>
                  <ThemedText 
                    style={[styles.premiumButtonText, {color: Colors.primaryAccentColor}]}
                  >
                    Start free trial
                  </ThemedText>
                </View>
          ...
          >
            <View style={styles.freeTalkContent}>
              ...
              <ThemedText style={{ color: Colors.subduedTextColor, marginTop: 4 }}>
                Describe a scenario of your choice to create you custom Roleplay experience.
              </ThemedText>
            </View>
            ...
            {COURSE_DATA.scenarios.map((scenario) => (
              ...
              >
                {scenario.id.startsWith("custom") && (
                  <View style={[styles.freeBadge, {backgroundColor: Colors.light.text + "22"}]}>
                    <ThemedText style={[styles.freeBadgeText, {color: Colors.subduedTextColor}]}>
                      CUSTOM
                    </ThemedText>
                  </View>
                )}
                {scenario.isFree && (
                  <View style={[styles.freeBadge, {backgroundColor: Colors.primaryAccentColor}]}>
                ...
                <ThemedText style={styles.scenarioTitle} type="defaultSemiBold">
                  {scenario.title}
                </ThemedText>
                <View style={styles.scenarioIconContainer}>
                  <Ionicons 
                    name={scenario.icon}
                    size={40}
                    color={scenario.isFree || isPremium? Colors.primaryAccentColor : Colors.subduedTextColor}
                  />
                </View>
              </TouchableOpacity>
            ))}
      ...
      >
        <View style={{flex: 1}}>
          <SafeAreaView style={{flex: 1}}>
            ...
            >
              {isPhrasebookOpen? ((selectedScenario?.phrasebook?? []).map((p, idx) => (
                <View key={`${p.hanzi}-${idx}`} style={[styles.phraseRow, {
