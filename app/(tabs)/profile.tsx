    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          >
            <View style={[styles.avatarContainer, {backgroundColor: Colors.primaryAccentColor}]}>
            ...
            <ThemedText style={[styles.userEmail, {color: Colors.subduedTextColor}]}>
              {user?.email}
            </ThemedText>
          </View>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={[styles.statSeparator, {backgroundColor: Colors.borderColor}]} />
          ...
          <TouchableOpacity
            ...
            style={[styles.premiumCard, {backgroundColor: Colors.primaryAccentColor}]}
          >
