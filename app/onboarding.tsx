    ...
    <View style={styles.stepContainer}>
      ...
      <ScrollView contentContainerStyle={{rowGap: 16}} style={{ marginTop: 20 }}>
        {LEVELS.map((l) => (
          <TouchableOpacity 
            key={l.id} 
            style={[styles.optionCard, level === l.id && {borderColor: Colors.primaryAccentColor, backgroundClip: "#fff5f0"}]}
      ...
      <ScrollView contentContainerStyle={{rowGap: 16}} style={{ marginTop: 10 }}>
        {MOTIVATIONS.map((m) => {
          ...
          return (
            <TouchableOpacity 
              key={m.id} 
              style={[styles.optionCard, styles.motivationCard, isSelected && {
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.progressBarContainer}>
            <View style={[styles.progressBar, {width: `${((step + 1)/4) * 100}%`, backgroundColor: Colors.primaryAccentColor}]}>
            </View>
          </View>
        </View>
