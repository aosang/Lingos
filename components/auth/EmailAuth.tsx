  ...
  return (
    <Animated.View style={[styles.viewContainer, menuContentAnimatedStyle]}>
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.emailSubtitle}>We will send you a magic link to sign in</Text>
      </View>
      ...
      <View style={styles.formContainer}>
        ...
        <Pressable
          ...
          disabled={loading}
        >
          <Text style={styles.verificationButtonText}>{loading? "Sending" : "Send magic link"}</Text>
        </Pressable>
      </View>
    </Animated.View>
  )
