...
export default function LessonCompleteScreen ({
  ...
  return (
    <View style={styles.container}>
      <LinearGradient style={styles.gradient} colors={["#fff", "#f9fafb", "#f3f4f6", ]} />
      <ScrollView 
      ...
      >
        ...
        >
          ...
          <ThemedText style={styles.performanceMessage}>{getPerformanceMessage()}</ThemedText>
        </Animated.View>

        {/* Accuracy Card */}
        <Animated.View style={[styles.accuracyCard, {
          opacity: fadeAnim,
          backgroundColor: "#fff",
          borderColor: "#e5e7eb"
        }]}>
          <View style={[styles.accuracyIcon, {backgroundColor: getPerformanceColor() + "20"}]}>
            <Ionicons name="checkmark-circle" size={40}  color={getPerformanceColor()}  />
          </View>
          <View style={styles.accuracyText}>
            <ThemedText style={styles.accuracyValue}>{lessonStats.accuracy}%</ThemedText>
            <ThemedText style={[styles.accuracyLabel, {color: Colors.subduedTextColor}]}>
        ...
        {lessonStats.wrongQuestions && lessonStats.wrongQuestions.length > 0 && (
          <Animated.View style={[styles.wrongSection, {opacity: fadeAnim}]}>
            ...
            <ThemedText style={[styles.wrongSubtitle, {color: Colors.subduedTextColor}]}>
              ...
              >
                ...
                <View style={styles.questionContent}>
                  ...
                  <View style={styles.questionMandarin}>
                    ...
                    <ThemedText style={[styles.questionHanzi, {color: Colors.subduedTextColor}]}>
                ...
                {question.attempts >= 1 && (
                  <View style={styles.attemptsIndicator}>
                    ...
                    <ThemedText style={[styles.attemptsText, {color: "#ef4444"}]}>
                      {question.attempts}
                    </ThemedText>
                  </View>
                )}
