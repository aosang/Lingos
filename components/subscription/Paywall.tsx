          ...
          >
            ...
            <View style={styles.introSection}>
              <Text style={styles.title}>
                Join over <Text style={styles.highlight}>5 million</Text> user
              </Text>
              <Text style={styles.subtitle}>learning with Lingos!</Text>
            </View>
            ...
            <View style={styles.featuresContainer}>
              {features.map((features, index) => (
                <View key={index} style={styles.featureCard}>
                  ...
                  <Text style={styles.featureDescription}>{features.description}</Text>
                </View>
              ))}
            </View>
            ...
            <View style={styles.planCard}>
              ...
              <View style={styles.planHeader}>
                <View>
                  ...
                  <Text style={styles.planBilling}>{selectedPlan.billingCycle}</Text>
                </View>
              ...
              <View style={styles.planFeatures}>
                {selectedPlan.features.map((feature, index) => (
                  <View key={index} style={styles.planFeatureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={"#33c759"} />
